...
def invalidarArquivo(file):
    with open(sys.argv[1], "w") as dado:
...
if __name__ == '__main__':
    if len(sys.argv) == 3: 
        ...
        if tipodeordenacao == 'Q' or tipodeordenacao == 'H' or tipodeordenacao == 'M' or tipodeordenacao == 'I' and metododeordenacao == 'C':
